...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': '', 'description': 'namespace for camera (empty = root namespace)'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '640x480x30', 'description': 'color stream profile (640x480x30: 降带宽防丢帧, YOLO 输入足够)'},
                           {'name': 'rgb_camera.color_format',      'default': 'RGB8', 'description': 'color stream format'},
                           {'name': 'rgb_camera.enable_auto_exposure', 'default': 'true', 'description': 'enable/disable auto exposure for color image'},
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'enable_infra',                 'default': 'false', 'description': 'enable infra0 stream'},
                           {'name': 'enable_infra1',                'default': 'true', 'description': 'enable infra1 stream (VINS stereo left)'},
                           {'name': 'enable_infra2',                'default': 'true', 'description': 'enable infra2 stream (VINS stereo right)'},
                           {'name': 'depth_module.depth_profile',   'default': '640x480x15', 'description': 'depth stream profile (640x480x15: 降 USB 带宽, 防丢帧)'},
                           ...
                           {'name': 'enable_sync',                  'default': 'true', 'description': "'enable sync mode (对齐多流时间戳, VINS 双目需要)'"},
